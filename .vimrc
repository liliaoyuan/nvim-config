...
set cindent
hi CursorLine cterm=none ctermbg=239 term=bold cterm=bold guibg=NONE guifg=NONE guifg=NONE
hi CursorColumn cterm=none ctermbg=239 term=bold cterm=bold guibg=NONE guifg=NONE guifg=NONE
